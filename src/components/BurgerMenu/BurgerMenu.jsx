...
const BurgerMenu = () => {
  ...
  const setBurgerActiveLink = ({ isActive }) =>
    isActive ? 'burger__link-active' : 'burger__link';
    ...
    <>
      ...
      <div
        className={`burger__background ${
          isMenuOpen ? 'burger__background_active' : ''
        }`}
        onClick={closeMenu}
      ></div>
      <button
        className={`burger__btn ${isMenuOpen && 'burger__btn_close'}`}
